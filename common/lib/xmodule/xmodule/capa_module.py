...
class CapaFields(object):
    ...
    minutes_allowed = Integer(help="Number of minutes allowed to finish this assessment. Set 0 for no time-limit",
...
class CapaModule(CapaFields, XModule):
    ...
    def exceeded_time_limit(self):
        ...
        # built in hardcoded grace period of 1 min
        time_limit_end = self.time_started + datetime.timedelta(minutes=(self.minutes_allowed + 1))
